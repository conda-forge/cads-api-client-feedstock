About cads-api-client-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/cads-api-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cads-api-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cads-api-client
# for installing globally
pixi global install cads-api-client
```
...
It is possible to list all of the versions of `cads-api-client` available on your platform:
...
```
pixi search cads-api-client --channel conda-forge
```
